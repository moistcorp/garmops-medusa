...
export async function PATCH(req: AuthenticatedMedusaRequest, res: MedusaResponse) {
  const body = req.body as { quantity?: number; sizes?: Record<string, number>; sizeBreakdown?: Record<string, number>; deliveryType?: string; configuration?: Record<string, unknown> }
