...
const complete = {
  ...
  PAYU_KEY: "payu-key", PAYU_SALT: "payu-salt", PAYU_ENV: "live", PAYU_CALLBACK_URL: "https://api.example.com/payments/payu/callback", PAYU_BROWSER_RETURN_URL: "https://api.example.com/payments/payu/return", TURNSTILE_SECRET_KEY: "turnstile-secret",
